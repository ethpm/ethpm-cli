...
def test_ethpm_registry_commands():
    ...
    add_child = pexpect.spawn(
        "ethpm registry add erc1319://0x1230000000000000000000000000000000000000:1 --alias mine"
    )
    ...
    # test registry list
    child = pexpect.spawn("ethpm registry list")
    ...
    child_add = pexpect.spawn(
        "ethpm registry add erc1319://0xabc0000000000000000000000000000000000000:3 --alias yours"  # noqa: E501
    )
    ...
    child_three = pexpect.spawn(
        "ethpm registry activate erc1319://0x1230000000000000000000000000000000000000:1"
    )
    ...
    # check activation successful
    child_four = pexpect.spawn("ethpm registry list")
    ...
    child_five = pexpect.spawn(
        "ethpm registry explore erc1319://0x16763EaE3709e47eE6140507Ff84A61c23B0098A:1",
        timeout=90,
    )
    ...
    child_five.expect("\r\n")
    child_five.expect("Total releases: 1")
    child_five.expect("\r\n\r\n")
